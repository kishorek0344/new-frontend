                    ...
                    <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg max-w-screen-sm max-h-screen overflow-auto relative">
                        ...
                        <p>
                            <ul className="list-disc pl-5">
                                ...
                                <li>Send the screenshot along with your delivery address and product details to the WhatsApp number: <strong onClick={() => copyToClipboard('+91 73971 07784')} className="cursor-pointer text-blue-500">+91 73971 07784</strong>.</li>
